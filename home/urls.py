...
from home.views import home_view, add_student_form_view, list_student_view, perm, StudentView, StudentUpdateView, class_attendence
...
urlpatterns = [
    ...
    path('attendence/', class_attendence, name='attendence'),
